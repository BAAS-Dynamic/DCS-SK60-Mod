...
ERadio_IND_TEX_PATH        = LockOn_Options.script_path .. "../Textures/EADI/" 
...
-- basic_eadi_material = MakeMaterial(ERadio_IND_TEX_PATH.."EADI_BASE_IND.dds", EADI_DAY_COLOR)
...
function ERadio_vert_gen(width, height)
...
function ERadio_duo_vert_gen(width, total_height, not_include_height)
    return {
