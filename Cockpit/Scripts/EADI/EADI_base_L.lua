...
RTOP_text_box.formats           = {"TR: %.1f","%s"} -- The output is set here, similar to the printf model of C.% is the output type at the beginning, and the following %s is the input type
RTOP_text_box.element_params    = {"YAWDAMPER","LEADI_DIS_ENABLE"}--{"L_EADI_DISPLAY_TR1"} -- top left first line display
