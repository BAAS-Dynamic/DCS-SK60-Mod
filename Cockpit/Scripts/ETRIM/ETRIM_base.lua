dofile(LockOn_Options.script_path.."ETRIM/ETRIM_def.lua")
...
erpm_base_clip.name 			    = "etrim_base_clip"
...
RTOP_text_box.element_params    = {"ELEV_TRIM_DIGTAL","ERPM_ENABLE"} -- top left first line display
