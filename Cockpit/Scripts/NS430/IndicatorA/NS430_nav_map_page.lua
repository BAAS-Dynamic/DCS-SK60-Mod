...
for i = 0, 100, 1 do
    ...
    airport_icon.controllers              = {{"opacity_using_parameter",0},{"move_up_down_using_parameter",4,map_scaler},{"move_left_right_using_parameter",3,map_scaler}}
    ...
    airport_name.controllers       = {{"opacity_using_parameter",0},{"move_up_down_using_parameter",4,map_scaler},{"move_left_right_using_parameter",3,map_scaler},{"text_using_parameter",5}}
