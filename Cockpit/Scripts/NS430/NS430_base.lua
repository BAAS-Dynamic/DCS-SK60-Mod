...
Moving_Map_Clip.vertices 		        = { {0.7715, aspect * 0.92773}, {0.7715,-aspect * 0.92773}, {-0.7715,-aspect * 0.92773}, {-0.543,aspect * 0.92773},} --四个边角
Moving_Map_Clip.indices 		        = {0,1,2,0,2,3}
Moving_Map_Clip.init_pos		        = {0.2285, 0.0722344, 0}
Moving_Map_Clip.init_rot		        = {0, 0, 0}
Moving_Map_Clip.material		        = "DBG_GREEN"
...
Moving_Map_Clip.element_params          = {"NS430_MAP_DISPLAY", "NAVU_BASE_ENABLE"}              -- Initialize the main display control
Moving_Map_Clip.controllers             = {{"opacity_using_parameter",0},{"opacity_using_parameter",1}}
...
eadi_adi_rotate.controllers             = {{"move_up_down_using_parameter",0,0.05},{"move_left_right_using_parameter",1,0.05}}
...
eadi_adi_rotate.level                   = NS430_DEFAULT_LEVEL
eadi_adi_rotate.parent_element	        = "navu_moving_map_center"
...
for i = 1, 100, 1 do
    ...
    airport_icon.material                 = "DBG_GREY"--blue_ns430_material
    airport_icon.name 			          = create_guid_string()
    airport_icon.init_pos                 = {0, 0, 0}
    airport_icon.init_rot		          = {0, 0, 0}
    airport_icon.collimated	              = true
    airport_icon.element_params           = {"NS430_MAP_DISPLAY", "NAVU_BASE_ENABLE", "AIRPORT_ENABLE_"..i, "AIRPORT_LON_"..i, "AIRPORT_LAT_"..i}
    airport_icon.controllers              = {{"opacity_using_parameter",0},{"opacity_using_parameter",1},{"opacity_using_parameter",2},{"move_up_down_using_parameter",3,0.05},{"move_left_right_using_parameter",4,0.05}}
    ...
    airport_name.controllers       = {{"opacity_using_parameter",0},{"opacity_using_parameter",1},{"opacity_using_parameter",2},{"move_up_down_using_parameter",3,0.05},{"move_left_right_using_parameter",4,0.05},{"text_using_parameter",5}}
