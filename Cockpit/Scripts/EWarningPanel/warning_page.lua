...
base_clip.element_params        = {"WARNING_DIS_ENABLE", "TEST"}              -- Initialize the main display control
base_clip.controllers           = {{"opacity_using_parameter",0}}
base_clip.isvisible		        = SHOW_MASKS
Add(base_clip)

local elem_size_x = 240
...
for i = 1, elem_num_total, 1 do
    ...
    warn_elements.element_params            = {"WARNING_DIS_ENABLE_1", "WARN_"..element_name[i]}
    warn_elements.controllers               = {{"opacity_using_parameter",1}}
