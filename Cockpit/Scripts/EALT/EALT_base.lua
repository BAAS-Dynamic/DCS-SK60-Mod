...
LLINEA_TEXT.element_params    = {"ALT_XK_DIGTAL","EALT_DIS_ENABLE"} -- top left first line display
LLINEA_TEXT.controllers       = {{"text_using_parameter",0},{"opacity_using_parameter",1}}
...
LLINEB_TEXT.element_params    = {"ALT_BARO_DIGTAL","EALT_DIS_ENABLE"} -- top left first line display
LLINEB_TEXT.controllers       = {{"text_using_parameter",0},{"opacity_using_parameter",1}}
...
LLINECMARK_TEXT.element_params    = {"ALT_BARO_UNIT_DIGTAL","EALT_DIS_ENABLE"} -- top left first line display
LLINECMARK_TEXT.controllers       = {{"text_using_parameter",0},{"opacity_using_parameter",1}}
...
RLINEAMARK_TEXT.element_params    = {"ALT_UNIT_DIGTAL","EALT_DIS_ENABLE"} -- top left first line display
RLINEAMARK_TEXT.controllers       = {{"text_using_parameter",0},{"opacity_using_parameter",1}}
...
RLINEA_TEXT.element_params    = {"ALT_XH_DIGTAL","EALT_DIS_ENABLE"} -- top left first line display
RLINEA_TEXT.controllers       = {{"text_using_parameter",0},{"opacity_using_parameter",1}}
