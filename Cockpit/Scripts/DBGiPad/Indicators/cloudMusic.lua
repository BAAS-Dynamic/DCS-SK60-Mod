...
for i=1,#mp3List,1 do
	...
	mp3_disk_img.state_tex_coords               = tex_scaler_test_gen(mp3List[i].img_w/2,mp3List[i].img_h/2,mp3List[i].img_w,mp3List[i].img_h,mp3List[i].img_w,mp3List[i].img_h,2,30)
	...
	mp3_disk_img.element_params            		= {"MP3_DISK_IMG_ENABLE_"..i, "TEST_TEXTURE_STATE"} --, "D_GUNSIGHT_VISIBLE"
	mp3_disk_img.controllers               		= {{"opacity_using_parameter",0},{"change_texture_state_using_parameter",1}}
