...
-- mirror settings
mirrors_data = {
    center_point      	= { 0.279, 0.2, 0.00 }, --F/B,U/D,L/R location of reflection image generation--{ 0.279, 0.4, 0.00 }, difference from cockpit_local_point {2.00, 0.2553,-0.2576},
    width 			  	= 1.7, --integrated (keep in mind that mirrors can be none planar old=0.7)
    aspect 			  	= 1.0,--0.8/0.3,
	rotation 	 	 	= math.rad(-5);
	animation_speed  	= 2.0;
	near_clip 		  	= 0.1;
