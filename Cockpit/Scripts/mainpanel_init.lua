...
-- mirror settings
mirrors_data = {
    center_point      	= { 0.01, 0.0, 0.0 }, --F/B,U/D,L/R location of reflection image generation--{ 0.279, 0.4, 0.00 } 0.279, 0.3, 0.00, difference from cockpit_local_point {2.00, 0.2553,-0.2576},
    width 			  	= 1.4, --integrated (keep in mind that mirrors can be none planar old=0.7)
    aspect 			  	= 4,--0.8/0.3,
