	...
	SFM_Data = {
		aerodynamics = -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
		{
			...
			{	--      M		Cx0		 	Cya			B		 	B4	    	Omxmax		Aldop		Cymax
				...
				[2] = 	{0.4,	0.035,		0.07,		0.042,		0.012,		2.0,		21,			1.16},
				[3] = 	{0.5,	0.042,		0.07,		0.042,		0.012,		2.0,		21,			1.16},
				[4] = 	{0.6,	0.0444,		0.08,		0.072,		0.12,		4.2,		15,			1.12},
				[5] = 	{0.7,	0.0488,		0.08,		0.072,		0.12,		4.2,		15,			1.12},
				[6] = 	{0.8,	0.235,		0.08,		0.072,		0.12,		4.2,		11,			1.18},
				[7] = 	{0.9,	0.468,		0.08,		0.072,		0.12,		4.2,		10,			1.25},
				[8] = 	{1.0,	0.990,		0.08,		0.072,		0.12,		4.2,		10,			2.35},
			}, -- end of table_data
			-- M - Mach number
		...
		engine = 
		{
			...
			table_data = 
			-- take 3000 m as reference
			{		--   M		Pmax		 Pfor	
				[1] = 	{0.0,	17363 * 1.016,	26000},
				[2] = 	{0.2,	17363 * 1.009,	26000},
				[3] = 	{0.4,	17363 * 0.995,	26000},
				[4] = 	{0.6,	17363 * 0.993,	23000},
				[5] = 	{0.8, 	17363 * 1.005, 	21000},
				[6] = 	{1.0, 	10000, 	18000},
				-- p for is not used
			}, -- end of table_data
			-- M - Mach number
