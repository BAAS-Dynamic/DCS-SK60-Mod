	...
	SFM_Data = {
		aerodynamics = -- Cx = Cx_0 + Cy^2*B2 +Cy^4*B4
		{
			...
			{	--      M		Cx0		 	Cya			B		 	B4	    	Omxmax		Aldop		Cymax
				...
				[2] = 	{0.6,	0.0804,		0.08,		0.072,		0.12,		4.2,		15,			1.12},
				[3] = 	{0.7,	0.118,		0.08,		0.072,		0.12,		4.2,		15,			1.12},
				[4] = 	{0.8,	0.235,		0.08,		0.072,		0.12,		4.2,		11,			1.18},
				[5] = 	{0.9,	0.468,		0.08,		0.072,		0.12,		4.2,		10,			1.25},
				[6] = 	{1.0,	0.990,		0.08,		0.072,		0.12,		4.2,		10,			2.35},
			}, -- end of table_data
			-- M - Mach number
		...
		engine = 
		{
			...
			{		--   M		Pmax		 Pfor	
				...
				[4] = 	{0.6,	17373 * 0.993,	23000},
				[5] = 	{0.8, 	17373 * 1.005, 	21000},
				[6] = 	{1.0, 	10000, 	18000},
				-- p for is not used
			}, -- end of table_data
			-- M - Mach number
